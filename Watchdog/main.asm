...
;********************************************************************************
;* @brief Initializes the hardware. Pin change interrupt is enabled on the
;*        button and the watchdog timer is enabled in system reset mode with
;*        a 1024 ms timeout.
;********************************************************************************
setup:
    ldi r24, low(led1_addr)
    ...
    ldi r24, watchdog_timeout_1024ms
    rcall watchdog_init
    rcall watchdog_enable_system_reset
    ret
